...
#define DEFINE_OPCODE_HANDLER(opcode, status, processing, handler)                                      \
	...
	// MoP Unhandled
	DEFINE_OPCODE_HANDLER(CMSG_MOP_UNKOWN_1,                            STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
	DEFINE_OPCODE_HANDLER(CMSG_MOP_UNKOWN_2,                            STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
