...
struct AreaTableEntry
{
    ...
    // uint32 unk11;                                        // 11
    int32   area_level;                                     // 12
	//char*	localization_area_name;                         // 13 - MoP
	uint32  team;                                           // 14,
    uint32  LiquidTypeOverride[4];                          // 15-18, liquid override by type
    float   MaxDepth;                                       // 19,
    //float  unk20;                                         // 20,
    //uint32 unk21;                                         // 21, All zeros (4.2.2)
...
struct ScalingStatValuesEntry
{
    uint32 Id;                                              // 0
    uint32 Level;                                           // 1
    uint32 dpsMod[6];                                       // 2-7 DPS mod for level - ! something was added here in MoP...
